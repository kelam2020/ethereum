...
function getLastBlockNumber() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = new ethers_1.ethers.providers.InfuraProvider('mainnet', // Specify the network (mainnet in this case)
...
function getUSDTBalance(address) {
    return __awaiter(this, void 0, void 0, function () {
        var web3, contractAddress, contract, balance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    web3 = new web3_1.default('https://mainnet.infura.io/v3/49VTNp94nvMnv77WXOJa/njpE3fZW2v7q0Ah+er2Rg7PMAY7XmWYpg');
                    contractAddress = 'malek';
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var lastBlockNumber, address, balance, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, getLastBlockNumber()];
                case 1:
                    lastBlockNumber = _a.sent();
                    console.log('Last block number:', lastBlockNumber);
                    address = 'malek';
                    return [4 /*yield*/, getUSDTBalance(address)];
                case 2:
                    balance = _a.sent();
